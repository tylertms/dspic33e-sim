...
DOCUMENTED_SIDE_EFFECT_OVERRIDES = {
    ...
    ("PMADDR", 0x0604): 0xFFFF,
    ("PMDOUT2", 0x0606): 0xFFFF,
    ("PMDIN1", 0x0608): 0xFFFF,
    ("PMDIN2", 0x060A): 0xFFFF,
    ("ALRMVAL", 0x0620): 0xFFFF,
    ("ALCFGRPT", 0x0622): 0x83FF,
    ("RTCVAL", 0x0624): 0xFFFF,
    ("RCFGCAL", 0x0626): 0xA000,
    ("OSCCON", 0x0742): 0x0001,
    ("CLKDIV", 0x0744): 0x7800,
    ("REFOCON", 0x074E): 0x0F00,
    ...
    ("OC1CON1", 0x0900): 0x0070,
    ("OC1CON2", 0x0902): 0x0040,
    ("OC2CON1", 0x090A): 0x0070,
    ("OC2CON2", 0x090C): 0x0040,
    ("OC3CON1", 0x0914): 0x0070,
    ("OC3CON2", 0x0916): 0x0040,
    ("OC4CON1", 0x091E): 0x0070,
    ("OC4CON2", 0x0920): 0x0040,
    ("OC5CON1", 0x0928): 0x0070,
    ("OC5CON2", 0x092A): 0x0040,
    ("OC6CON1", 0x0932): 0x0070,
    ("OC6CON2", 0x0934): 0x0040,
    ("OC7CON1", 0x093C): 0x0070,
    ("OC7CON2", 0x093E): 0x0040,
    ("OC8CON1", 0x0946): 0x0070,
    ("OC8CON2", 0x0948): 0x0040,
    ("OC9CON1", 0x0950): 0x0070,
    ("OC9CON2", 0x0952): 0x0040,
    ("OC10CON1", 0x095A): 0x0070,
    ("OC10CON2", 0x095C): 0x0040,
    ("OC11CON1", 0x0964): 0x0070,
    ("OC11CON2", 0x0966): 0x0040,
    ("OC12CON1", 0x096E): 0x0070,
    ("OC12CON2", 0x0970): 0x0040,
    ("OC13CON1", 0x0978): 0x0070,
    ("OC13CON2", 0x097A): 0x0040,
    ("OC14CON1", 0x0982): 0x0070,
    ("OC14CON2", 0x0984): 0x0040,
    ("OC15CON1", 0x098C): 0x0070,
    ("OC15CON2", 0x098E): 0x0040,
    ("OC16CON1", 0x0996): 0x0070,
...
DOCUMENTED_READ_ONLY_OVERRIDES = {
    ...
    ("DOSTARTH", 0x003C): 0x003F,
    ("DOSTARTL", 0x003A): 0xFFFE,
}
