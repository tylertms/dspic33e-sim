...
static void key_sequence_cases(TestState* state, Dspic33* cpu) {
    dspic33_reset(cpu, 0u);
    configure_operation(cpu, 1u, 0x2000u, true);
...
static void key_byte_access_cases(TestState* state, Dspic33* cpu) {
    dspic33_reset(cpu, 0u);
...
static void invalid_operation_cases(TestState* state, Dspic33* cpu) {
    uint16_t operation;
...
static void program_range_cases(TestState* state, Dspic33* cpu) {
    dspic33_reset(cpu, 0u);
...
static void configuration_operation_cases(TestState* state, Dspic33* cpu) {
...
static void configuration_programming_matrix_cases(TestState* state, Dspic33* cpu) {
    uint16_t current;
    uint16_t latch;
    uint16_t general;
    uint16_t auxiliary;
...
static void row_operation_cases(TestState* state, Dspic33* cpu) {
    uint32_t index;
    dspic33_reset(cpu, 0u);
...
static void erase_operation_cases(TestState* state, Dspic33* cpu) {
    dspic33_reset(cpu, 0u);
...
static void auxiliary_access_and_execution_cases(TestState* state, Dspic33* cpu) {
    Dspic33 copy;
...
static void auxiliary_nvm_cases(TestState* state, Dspic33* cpu) {
    uint32_t index;
    uint64_t instructions;
...
static void stall_and_interrupt_cases(TestState* state, Dspic33* cpu) {
    dspic33_reset(cpu, 0u);
...
static void same_segment_stall_erratum_cases(TestState* state, Dspic33* cpu) {
    dspic33_reset(cpu, 0u);
    cpu->write_latches[0] = 0x00112233u;
...
static void codeguard_cases(TestState* state, Dspic33* cpu) {
