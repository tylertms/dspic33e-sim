...
static void unsupported_case(TestState* state, Dspic33* cpu, uint16_t control1,
...
static void input_capture_cascade_synchronization_cases(TestState* state,
                                                        Dspic33* cpu) {
    uint8_t channel;
    uint8_t source;
    dspic33_reset(cpu, 0u);
...
static void input_capture_synchronization_lifecycle_cases(TestState* state,
                                                          Dspic33* cpu) {
    Dspic33 copy;
