...
void dspic33_i2c_test_pin_routing_cases(TestState* state, Dspic33* cpu) {
    ...
    dspic33_i2c_test_enable(cpu, 1u, 0u, 2u);
    expect(state,
           dspic33_i2c_pin(cpu, 5u, 5u, &is_high) && is_high &&
               dspic33_i2c_pin(cpu, 5u, 4u, &is_high) && is_high,
    ...
    expect(state,
           !dspic33_i2c_pin(cpu, 0u, 2u, &is_high) && !dspic33_i2c_pin(cpu, 0u, 3u, &is_high),
           "standard I2C2 leaves alternate pins under port control");
    dspic33_gpio_drive(cpu, 5u, 0u, 0x0010u);
    expect(state, dspic33_i2c_pin(cpu, 5u, 4u, &is_high) && !is_high,
    ...
    expect(state,
           !dspic33_i2c_pin(cpu, 5u, 5u, &is_high) && dspic33_gpio_pin(cpu, 5u, 5u, &is_high) &&
               !is_high,
    ...
    expect(state,
           dspic33_i2c_pin(cpu, 0u, 2u, &is_high) && is_high &&
               dspic33_i2c_pin(cpu, 0u, 3u, &is_high) && is_high,
           "alternate I2C2 pins are selected and released");
    expect(state,
           !dspic33_i2c_pin(cpu, 5u, 5u, &is_high) && !dspic33_i2c_pin(cpu, 5u, 4u, &is_high),
    ...
    dspic33_write_word(cpu, (uint16_t)(bases[1] + 6u), 0x9040u);
    expect(state, dspic33_i2c_pin(cpu, 0u, 2u, &is_high) && is_high,
    ...
    expect(state,
           dspic33_i2c_pin(cpu, 3u, 10u, &is_high) && is_high &&
               dspic33_i2c_pin(cpu, 3u, 9u, &is_high) && is_high,
    ...
    dspic33_i2c_test_enable(cpu, 0u, 0u, 0u);
    expect(state,
           !dspic33_i2c_pin(cpu, 3u, 10u, &is_high) && !dspic33_i2c_pin(cpu, 3u, 9u, &is_high) &&
               !dspic33_i2c_pin(cpu, 6u, 2u, &is_high) && !dspic33_i2c_pin(cpu, 6u, 3u, &is_high),
    ...
    expect(state, dspic33_i2c_pin(cpu, 5u, 5u, &is_high) && is_high,
           "pending I2C2 PMD transition retains pin ownership");
    expect(state, dspic33_device_advance(cpu, 1u) && !dspic33_i2c_pin(cpu, 5u, 5u, &is_high),
           "effective I2C2 PMD disable releases pins");
    dspic33_write_word(cpu, 0x0764u, 0u);
    expect(state, !dspic33_i2c_pin(cpu, 5u, 5u, &is_high),
           "pending I2C2 PMD enable leaves pins released");
    expect(state,
           dspic33_device_advance(cpu, 1u) && dspic33_i2c_pin(cpu, 5u, 5u, &is_high) && is_high,
           "effective I2C2 PMD enable restores pin ownership");

    copy_initialized = dspic33_initialize(&copied_cpu);
    expect(state, copy_initialized, "initialize I2C pin-plane copy");
    if (copy_initialized) {
        expect(state, dspic33_copy(&copied_cpu, cpu), "copy I2C pin-plane state");
        expect(state,
               dspic33_i2c_pin(cpu, 5u, 5u, &is_high) && is_high &&
                   dspic33_i2c_pin(&copied_cpu, 5u, 5u, &copied_is_high) && copied_is_high,
               "copy preserves independent I2C pin ownership and input level");
        dspic33_load_configuration_word(cpu, 0xf8000cu, 0xffdfu);
        expect(state,
               dspic33_i2c_pin(cpu, 0u, 2u, &is_high) &&
                   dspic33_i2c_pin(&copied_cpu, 5u, 5u, &copied_is_high),
    ...
    expect(state,
           !dspic33_i2c_pin(cpu, DSPIC33_GPIO_PORT_COUNT, 0u, &is_high) &&
               !dspic33_i2c_pin(cpu, 0u, 16u, &is_high) && !dspic33_i2c_pin(cpu, 0u, 2u, NULL),
