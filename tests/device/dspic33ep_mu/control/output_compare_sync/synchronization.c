...
void dspic33_output_compare_sync_test_synchronization_control_cases(TestState* state,
                                                                    Dspic33* cpu) {
    uint16_t generation;
...
void dspic33_output_compare_sync_test_alternate_clock_control_cases(TestState* state,
                                                                    Dspic33* cpu) {
    dspic33_reset(cpu, 0u);
...
void dspic33_output_compare_sync_test_trigger_source_negative_cases(TestState* state,
                                                                    Dspic33* cpu) {
    dspic33_reset(cpu, 0u);
    configure_compare_mode(cpu, 15u, 6u, 4u, 2u, (uint16_t)(COMPARE_TRIGGER | 29u));
