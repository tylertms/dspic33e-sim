...
#define DSPIC33_GPIO_PORT_COUNT 10u
...
bool dspic33_uart_receive(Dspic33* cpu, uint8_t channel, uint8_t input_value, uint64_t event_delay);
...
bool dspic33_spi_receive(Dspic33* cpu, uint8_t channel, uint16_t input_value, uint64_t event_delay);
