...
static void reference_ladder_cases(ComparatorConformance* state, Dspic33* cpu) {
    uint8_t comparator;
    for (comparator = 0u; comparator < DSPIC33_COMPARATOR_COUNT; comparator++) {
...
static void blanking_source_cases(ComparatorConformance* state, Dspic33* cpu) {
...
static void blanking_logic_cases(ComparatorConformance* state, Dspic33* cpu) {
    uint8_t inputs;
    dspic33_reset(cpu, 0u);
...
static void filter_clock_cases(ComparatorConformance* state, Dspic33* cpu) {
    uint8_t comparator;
    for (comparator = 0u; comparator < DSPIC33_COMPARATOR_COUNT; comparator++) {
        uint8_t source;
...
static void filter_sequence_cases(ComparatorConformance* state, Dspic33* cpu) {
    dspic33_reset(cpu, 0u);
    set_comparator_relation(cpu, 0u, 200u, 100u);
...
static void blanking_transition_cases(ComparatorConformance* state, Dspic33* cpu) {
    dspic33_reset(cpu, 0u);
    set_comparator_relation(cpu, 0u, 200u, 100u);
    dspic33_write_word(cpu, 0x0c00u, 0x8000u);
...
static void reference_lifecycle_cases(ComparatorConformance* state, Dspic33* cpu) {
    Dspic33 copy;
...
static void filter_lifecycle_cases(ComparatorConformance* state, Dspic33* cpu) {
    Dspic33 copy;
    bool high;
    bool copy_initialized = dspic33_initialize(&copy);
...
static void filter_reconfiguration_cases(ComparatorConformance* state, Dspic33* cpu) {
    dspic33_reset(cpu, 0u);
    set_comparator_relation(cpu, 0u, 200u, 100u);
    dspic33_write_word(cpu, (uint16_t)(comparator_base(0u) + 6u), 0x000bu);
    dspic33_write_word(cpu, comparator_base(0u), COMPARATOR_ENABLE);
...
static void byte_access_behavior_cases(ComparatorConformance* state, Dspic33* cpu) {
    dspic33_reset(cpu, 0u);
...
static void dma_and_completed_feature_cases(ComparatorConformance* state,
                                            Dspic33* cpu) {
    dspic33_reset(cpu, 0u);
