...
static void receive_value_domain(UartConformance* state, Dspic33* cpu) {
...
static void transmit_value_domain(UartConformance* state, Dspic33* cpu) {
    static const uint16_t selections[] = {0u, 2u, 4u, 6u};
    uint8_t channel;
    uint8_t selection;
    uint16_t value;
...
static void receive_fifo_cases(UartConformance* state, Dspic33* cpu) {
...
static void special_receive_cases(UartConformance* state, Dspic33* cpu) {
    Dspic33UartFrame frame;
    dspic33_reset(cpu, 0u);
...
static void transmit_fifo_cases(UartConformance* state, Dspic33* cpu) {
    uint8_t index;
    Dspic33UartFrame output;
...
static void transmit_timing_cases(UartConformance* state, Dspic33* cpu) {
...
static void dma_cases(UartConformance* state, Dspic33* cpu) {
    uint8_t channel;
    for (channel = 0u; channel < DSPIC33_UART_COUNT; channel++) {
