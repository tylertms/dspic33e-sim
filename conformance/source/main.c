...
volatile uint16_t interrupt_entry_pc __attribute__((near));
...
volatile uint16_t system_program_read_trap_state[13] __attribute__((near));
volatile uint16_t system_program_read_buffer __attribute__((near));
volatile uint16_t system_sequential_hole_state __attribute__((near));
volatile uint16_t system_program_boundary_state[7] __attribute__((near));
volatile uint16_t system_skip_state[7] __attribute__((near));
...
volatile uint16_t system_pseudo_linear_state[12] __attribute__((near));
...
volatile uint16_t system_psv_repeat_state[7] __attribute__((near));
volatile uint16_t system_auxiliary_program_state[7] __attribute__((near));
volatile uint16_t system_move_file_fault_state[11] __attribute__((near));
volatile uint16_t system_crc_lane_state[4] __attribute__((near));
