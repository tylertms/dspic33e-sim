...
enum {
    ...
    PLATFORM_PMD_UART_BASE = 0u,
    PLATFORM_PMD_SPI_BASE = 4u,
    PLATFORM_PMD_CAN_BASE = 8u,
    PLATFORM_PMD_DMA_BASE = 10u,
    PLATFORM_PMD_REFERENCE_CLOCK = 14u,
    PLATFORM_PMD_COUNT = 15u,
    PLATFORM_PMD_EVENT_DISABLED = 0x00000001u,
    PLATFORM_PMD_EVENT_GENERATION_SHIFT = 1u,
    DMA_PWC = 0x0bf0u,
    DMA_RQC = 0x0bf2u,
    DMA_PPS = 0x0bf4u,
    DMA_LCA = 0x0bf6u,
    ...
    USB_HOST_RETRY_DISABLE = 0x0040u,
...
static const uint32_t UART_EVENT_KIND_MASK = UINT32_C(0xc0000000);
static const uint32_t UART_EVENT_CTS = UINT32_C(0x80000000);
static const uint32_t UART_EVENT_PIN = UINT32_C(0xc0000000);
